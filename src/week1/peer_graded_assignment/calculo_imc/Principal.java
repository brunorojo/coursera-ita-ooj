package week1.peer_graded_assignment.calculo_imc;

/**
 * Coursera - Orientação a Objetos com Java por Instituto Tecnológico da Aeronáutica
 * 
 * Projeto: Cálcular o IMC do paciente
 * 
 * @author Bruno Rojo
 * @date Junho de 2019
 *
...
public class Principal {
	...
	/**
	 * Classe Principal, que se cria 3 instâncias da classe Paciente com valores
	...
	public static void main(String[] args) {
		...
		Paciente p1 = new Paciente(50.0, 1.81); // peso e altura
